...
if __name__ == "__main__":
    ...
    suite.addTest(unittest.TestLoader().loadTestsFromTestCase(ps3_P1A))
    suite.addTest(unittest.TestLoader().loadTestsFromTestCase(ps3_P1B))
    suite.addTest(unittest.TestLoader().loadTestsFromTestCase(ps3_P2_ER))
    suite.addTest(unittest.TestLoader().loadTestsFromTestCase(ps3_P2_FR))
    suite.addTest(unittest.TestLoader().loadTestsFromTestCase(ps3_P3))
    suite.addTest(unittest.TestLoader().loadTestsFromTestCase(ps3_P5_Standard))
    suite.addTest(unittest.TestLoader().loadTestsFromTestCase(ps3_P5_Faulty))
